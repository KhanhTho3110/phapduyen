...
def process_data(products_raw, videos_raw):
    ...
    return products_processed, videos_processed
...
def build_site():
    ...
    products, videos = process_data(products_raw, videos_raw)
    ...
    output_html = template.render(products=products, videos=videos)
